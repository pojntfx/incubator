...
import pb from "../assets/pb-felicitas.jpg";

const felicitas = {
  head: {
    title: "Felicitas",
    description: "Information on Felicitas Pojtinger.",
  ...
  header: {
    ...
    handle: "pojntfx",
    text: `Minimalist cyberpunk that loves the web & JS.
Node + React fullstack dev, GNU/Linux/k8s geek and Free/Libre Open Source Software activist.`,
    mail: "felicitas@pojtinger.com",
